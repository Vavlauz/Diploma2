...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-следующий год
1. В поле "Владелец" ввести невалидное значение-имя и фамилию в количестве 250 букв
1. В поле CVC/CVV ввести валидное значение-три цифры
1. Нажать на кнопку "Продолжить"
...
- IntellijIDEA Ultimate 2021.3-среда разработки, поддерживающая множество плагинов, систем управления и контроля версий
...
- Google Chrome 101.0.4951.54-один из самых популярных и удобных браузеров.
...
1. Создание проекта и запуск SUT-5 часов.
1. Написание тест-плана - 6 часов.
1. Написание и прогон автотестов - 60 часов.
1. Дополнительное время на устранение замечаний - 16 часов.
